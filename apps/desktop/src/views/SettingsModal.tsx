  ...
  return (
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-section">
          <div className="modal-label">Architect AI</div>
          <div className="modal-help">
            The LLM API key is server-side only. The desktop app can ask The Architect questions,
            but it never receives provider secrets.
          </div>
        </div>
      </div>
    </div>
